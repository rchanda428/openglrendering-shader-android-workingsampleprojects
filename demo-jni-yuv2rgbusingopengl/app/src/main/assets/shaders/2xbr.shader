...
// 		gl_Position = vec4(-aPosition.x,aPosition.y, 0.0, 1.0); //not working
		gl_Position = vec4(aPosition.x,-aPosition.y, 0.0, 1.0);  //flipping

// 		gl_Position.x = -gl_Position.x  //not working
	}
]]></vertex>
